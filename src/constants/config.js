...
export const TOUR_PACKAGES = [
  {
    id: 1,
    title: "Varansi & Sarnath Tour",
    duration: "7 Days / 6 Nights",
    vehicle: "Suzuki Ertiga with Driver",
    description: "Explore the spiritual and cultural richness of Varanasi and Sarnath with our guided tour package.",
    price: "25000 INR",
  ...
  },
  {
    ...
    vehicle: "Suzuki Ertiga with Driver",
    description: "Discover the magnificence of the Taj Mahal and the historical significance of Agra with our comprehensive tour package.",
    price: "35000 INR",
  ...
  },
  {
    ...
    vehicle: "Suzuki Ertiga with Driver",
    description: "Relaxing holiday itinerary designed around custom travel pace and preferences.",
    price: "20000 INR",
